...
def trigger_user_notification_event(
    ...
    try:
        ...
        db_notification_task = crud.notification.get_notification_task_by_user_id_and_notification_trigger_event(
            db=db,
            user_id=user_id,
            trigger_event_uuid=trigger_event_uuid
        )
        if db_notification_task is not None and db_notification_task.enable:
