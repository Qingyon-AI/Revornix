...
class User(Base):
    ...
    default_document_parsing_engine = Column(Integer, ForeignKey("document_parsing_engine.id"))
    default_website_crawling_engine = Column(Integer, ForeignKey("website_crawling_engine.id"))
    create_time = Column(DateTime(timezone=True), nullable=False)
    update_time = Column(DateTime(timezone=True), nullable=False)
    delete_at = Column(DateTime(timezone=True))
