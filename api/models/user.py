...
class User(Base):
    ...
    default_audio_meeting_mode: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, comment='Default value of the meeting-record toggle for new audio documents')
