...
from base_implement.markdown_engine_base import MarkdownEngineBase, WebsiteInfo


class JinaEngine(MarkdownEngineBase):

    def __init__(self):
        super().__init__(
            engine_uuid=EngineProvided.Jina.meta.uuid,
            engine_name='Jina',
            engine_name_zh='Jina',
