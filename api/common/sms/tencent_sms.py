...
from config.sms import TENCENT_SMS_APP_KEY, TENCENT_SECRET_ID, TENCENT_SECRET_KEY, TENCENT_SMS_SDK_APP_ID, TENCENT_SMS_SIGN
...
class TencentSms:
    ...
    def send_register_msg(self, 
                          phone_numbers: list[str],
                          code: str):
        self._send_msg(phone_numbers=phone_numbers, 
                       template_id=2303546, 
                       params=[code])