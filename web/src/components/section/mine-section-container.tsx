...
import { getMineLabels, searchMineSection } from '@/service/section';
...
const MineSectionContainer = ({ label_id }: { label_id?: number }) => {
	...
	const {
		...
		queryKey: ['searchMySection', keyword, desc, labelIds],
		queryFn: (pageParam) => searchMineSection({ ...pageParam.pageParam }),
		initialPageParam: {
			limit: 10,
			keyword: keyword,
			label_ids: labelIds,
...
export default MineSectionContainer;
