...
const AuthShell = ({ children }: { children: ReactNode }) => {
	...
	return (
		<div className='relative flex h-full min-h-0 items-center justify-center overflow-hidden px-4 py-6 md:px-6 md:py-8'>
			...
			<div className='relative w-full max-w-5xl'>
				<div className='overflow-hidden rounded-[30px] border border-border/60 bg-background/92 shadow-[0_24px_70px_-36px_rgba(15,23,42,0.35)] backdrop-blur-sm dark:bg-card/88 dark:shadow-[0_28px_80px_-40px_rgba(0,0,0,0.6)]'>
					<div className='grid lg:min-h-[580px] lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.82fr)]'>
						<div className='px-6 py-7 md:px-8 md:py-8 lg:flex lg:flex-col lg:justify-center lg:px-10 lg:py-10'>
							<div className='w-fit inline-flex items-center gap-2 rounded-full border border-border/60 bg-background/72 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-muted-foreground backdrop-blur-sm'>
								<Sparkles className='size-3.5' />
								<span>{t('website_title')}</span>
							</div>
							<div className='mt-5 max-w-xl space-y-3'>
								<h1 className='text-balance text-[2rem] font-semibold leading-[1.08] tracking-tight text-foreground md:text-[2.2rem]'>
									{t('auth_shell_title')}
								</h1>
						...
						<div className='border-t border-border/60 bg-muted/25 px-6 py-7 dark:bg-background/30 md:px-7 md:py-8 lg:flex lg:items-center lg:border-l lg:border-t-0 lg:px-8 lg:py-10'>
