...
export default {
    ...
    getMineNotificationSources: API_PREFIX + '/notification/source/community',
    getUsableNotificationSources: API_PREFIX + '/notification/source/usable',
    ...
    getMineNotificationTargets: API_PREFIX + '/notification/target/community',
    getUsableNotificationTargets: API_PREFIX + '/notification/target/usable',
    ...
    getNotificationTemplatesCommunity: API_PREFIX + '/notification/template/community',
    upsertNotificationTemplate: API_PREFIX + '/notification/template/upsert',
    deleteNotificationTemplate: API_PREFIX + '/notification/template/delete',
    forkNotificationTemplate: API_PREFIX + '/notification/template/fork',
