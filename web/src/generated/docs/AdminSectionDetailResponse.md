...
```typescript
import type { AdminSectionDetailResponse } from ''
...
const example = {
  ...
  "ppt_preview": null,
} satisfies AdminSectionDetailResponse
...
const exampleParsed = JSON.parse(exampleJSON) as AdminSectionDetailResponse
