 ...
 * 
 * @export
 * @interface AdminDocumentDetailResponse
 */
...
/**
 * Check if a given object implements the AdminDocumentDetailResponse interface.
 */
export function instanceOfAdminDocumentDetailResponse(value: object): value is AdminDocumentDetailResponse {
...
export function AdminDocumentDetailResponseFromJSON(json: any): AdminDocumentDetailResponse {
    return AdminDocumentDetailResponseFromJSONTyped(json, false);
}

export function AdminDocumentDetailResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdminDocumentDetailResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function AdminDocumentDetailResponseToJSON(json: any): AdminDocumentDetailResponse {
    return AdminDocumentDetailResponseToJSONTyped(json, false);
}

export function AdminDocumentDetailResponseToJSONTyped(value?: AdminDocumentDetailResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
