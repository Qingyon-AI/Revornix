...
import {
    type DocumentUploadLimitResponse,
    DocumentUploadLimitResponseFromJSON,
    DocumentUploadLimitResponseToJSON,
} from '../models/DocumentUploadLimitResponse';
import {
    type FileSystemInfo,
...
export interface GetDocumentUploadLimitsFileSystemUploadLimitsPostRequest {
    authorization?: string | null;
    xUserTimezone?: string | null;
}
...
export class FileSystemApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for getDocumentUploadLimitsFileSystemUploadLimitsPost without sending the request
     */
    async getDocumentUploadLimitsFileSystemUploadLimitsPostRequestOpts(requestParameters: GetDocumentUploadLimitsFileSystemUploadLimitsPostRequest): Promise<runtime.RequestOpts> {
        const queryParameters: any = {};
        ...
        let urlPath = `/file-system/upload-limits`;
     ...
     */
    async getDocumentUploadLimitsFileSystemUploadLimitsPostRaw(requestParameters: GetDocumentUploadLimitsFileSystemUploadLimitsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DocumentUploadLimitResponse>> {
        const requestOptions = await this.getDocumentUploadLimitsFileSystemUploadLimitsPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => DocumentUploadLimitResponseFromJSON(jsonValue));
    }

    /**
     * Get Document Upload Limits
     */
    async getDocumentUploadLimitsFileSystemUploadLimitsPost(requestParameters: GetDocumentUploadLimitsFileSystemUploadLimitsPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DocumentUploadLimitResponse> {
        const response = await this.getDocumentUploadLimitsFileSystemUploadLimitsPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
