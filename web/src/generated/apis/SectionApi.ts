...
export interface UpdateSectionPublishAccessKeySectionPublishAccessKeyPostRequest {
...
export class SectionApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for updateSectionPublishAccessKeySectionPublishAccessKeyPost without sending the request
     */
    async updateSectionPublishAccessKeySectionPublishAccessKeyPostRequestOpts(requestParameters: UpdateSectionPublishAccessKeySectionPublishAccessKeyPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['sectionAccessKeyUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'sectionAccessKeyUpdateRequest',
                'Required parameter "sectionAccessKeyUpdateRequest" was null or undefined when calling updateSectionPublishAccessKeySectionPublishAccessKeyPost().'
            );
        }
        ...
        let urlPath = `/section/publish/access-key`;
     ...
     */
    async updateSectionPublishAccessKeySectionPublishAccessKeyPostRaw(requestParameters: UpdateSectionPublishAccessKeySectionPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NormalResponse>> {
        const requestOptions = await this.updateSectionPublishAccessKeySectionPublishAccessKeyPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Update Section Publish Access Key
     */
    async updateSectionPublishAccessKeySectionPublishAccessKeyPost(requestParameters: UpdateSectionPublishAccessKeySectionPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NormalResponse> {
        const response = await this.updateSectionPublishAccessKeySectionPublishAccessKeyPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
