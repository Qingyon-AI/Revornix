...
import {
    type DocumentAccessKeyUpdateRequest,
    DocumentAccessKeyUpdateRequestFromJSON,
    DocumentAccessKeyUpdateRequestToJSON,
} from '../models/DocumentAccessKeyUpdateRequest';
import {
...
import {
    type SectionAccessKeyUpdateRequest,
    SectionAccessKeyUpdateRequestFromJSON,
...
export interface SetDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequest {
    documentAccessKeyUpdateRequest: DocumentAccessKeyUpdateRequest;
    xUserTimezone?: string | null;
    apiKey?: string | null;
}

export interface SetSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequest {
    sectionAccessKeyUpdateRequest: SectionAccessKeyUpdateRequest;
    xUserTimezone?: string | null;
    apiKey?: string | null;
}
...
export class TpApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPost without sending the request
     */
    async setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequestOpts(requestParameters: SetDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['documentAccessKeyUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'documentAccessKeyUpdateRequest',
                'Required parameter "documentAccessKeyUpdateRequest" was null or undefined when calling setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPost().'
            );
        }
        ...
        let urlPath = `/tp/document/publish/access-key`;
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: DocumentAccessKeyUpdateRequestToJSON(requestParameters['documentAccessKeyUpdateRequest']),
        };
    }
     ...
     */
    async setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRaw(requestParameters: SetDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NormalResponse>> {
        const requestOptions = await this.setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Set Document Publish Access Key
     */
    async setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPost(requestParameters: SetDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NormalResponse> {
        const response = await this.setDocumentPublishAccessKeyTpDocumentPublishAccessKeyPostRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Creates request options for setSectionPublishAccessKeyTpSectionPublishAccessKeyPost without sending the request
     */
    async setSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequestOpts(requestParameters: SetSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['sectionAccessKeyUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'sectionAccessKeyUpdateRequest',
                'Required parameter "sectionAccessKeyUpdateRequest" was null or undefined when calling setSectionPublishAccessKeyTpSectionPublishAccessKeyPost().'
            );
        }
        ...
        let urlPath = `/tp/section/publish/access-key`;
        ...
        return {
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SectionAccessKeyUpdateRequestToJSON(requestParameters['sectionAccessKeyUpdateRequest']),
        };
    }
     ...
     */
    async setSectionPublishAccessKeyTpSectionPublishAccessKeyPostRaw(requestParameters: SetSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NormalResponse>> {
        const requestOptions = await this.setSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Set Section Publish Access Key
     */
    async setSectionPublishAccessKeyTpSectionPublishAccessKeyPost(requestParameters: SetSectionPublishAccessKeyTpSectionPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NormalResponse> {
        const response = await this.setSectionPublishAccessKeyTpSectionPublishAccessKeyPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
