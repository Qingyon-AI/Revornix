...
export interface UpdateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequest {
...
export class DocumentApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for updateDocumentPublishAccessKeyDocumentPublishAccessKeyPost without sending the request
     */
    async updateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequestOpts(requestParameters: UpdateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['documentAccessKeyUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'documentAccessKeyUpdateRequest',
                'Required parameter "documentAccessKeyUpdateRequest" was null or undefined when calling updateDocumentPublishAccessKeyDocumentPublishAccessKeyPost().'
            );
        }
        ...
        let urlPath = `/document/publish/access-key`;
     ...
     */
    async updateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRaw(requestParameters: UpdateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NormalResponse>> {
        const requestOptions = await this.updateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);
     ...
     * Update Document Publish Access Key
     */
    async updateDocumentPublishAccessKeyDocumentPublishAccessKeyPost(requestParameters: UpdateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NormalResponse> {
        const response = await this.updateDocumentPublishAccessKeyDocumentPublishAccessKeyPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
