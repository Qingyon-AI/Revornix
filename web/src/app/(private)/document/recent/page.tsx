...
import { getLabels, searchUserRecentReadDocument } from '@/service/document';
...
const RecentReadDocumentPage = () => {
	...
	const {
		...
		queryKey: ['searchUserRecentReadDocument', mainUserInfo?.id, keyword, desc, labelIds],
		queryFn: (pageParam) =>
...
export default RecentReadDocumentPage;
