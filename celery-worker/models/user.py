...
class User(Base):
    ...
    default_website_document_parse_user_engine_id = Column(Integer, ForeignKey("user_engine.id"))
    default_file_document_parse_user_engine_id = Column(Integer, ForeignKey("user_engine.id"))
