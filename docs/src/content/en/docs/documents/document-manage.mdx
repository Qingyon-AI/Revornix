...
<ProcessDiagram
	...
	steps={[
		{ title: 'Enter the system', description: 'Quick note, website, file, and audio all act as document entry points.' },
		{ title: 'Create the record', description: 'Metadata, source information, and initial tasks are stored.' },
		{ title: 'Parse or transcribe', description: 'Each document type enters the matching parsing or transcription flow.' },
		{ title: 'Generate core outputs', description: 'Markdown, summaries, and tags are filled in over time.' },
		{ title: 'Continue into extensions', description: 'Embedding, graph, podcast, and section workflows continue from there.' },
	]}
/>
...
<ProcessDiagram
	title='When a document enters a section'
	steps={[
		{ title: 'Document is bound to a section', description: 'The relationship can be created from the document or the section side.' },
		{ title: 'Section content changes', description: 'The section now has updated source material to aggregate.' },
		{ title: 'Processing is queued again', description: 'The section re-enters the processing queue based on its trigger rules.' },
		{ title: 'Derived outputs refresh', description: 'Markdown, podcast, PPT, and graph outputs may all update.' },
	]}
/>
