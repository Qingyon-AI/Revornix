...
The main built-in image engine implementations currently available are:

- `Banana Image`
- `Bailian Image`
- `Volc Image`

For the exact config requirements of each one, see the [engine guide](/en/docs/ai/engine).
...
On the public community surface, section discovery also supports public labels and cross-links to related public documents and creators. This means a published section can work as an SEO entry point, a topic hub, and a collaboration artifact at the same time.
