...
<ProcessDiagram
	title='Post-creation section flow'
	steps={[
		{ title: 'Create the section', description: 'Start with title, description, labels, and cover.' },
		{ title: 'Configure the strategy', description: 'Set trigger mode, auto publish, auto podcast, and auto illustration.' },
		{ title: 'Wait for processing conditions', description: 'Add documents or wait for the scheduled run time.' },
		{ title: 'Generate the body', description: 'The worker aggregates documents and produces section Markdown.' },
		{ title: 'Generate derived outputs', description: 'Illustration, podcast, PPT, and graph workflows continue from there.' },
		{ title: 'Enter public interaction', description: 'Publishing, subscribing, commenting, and public access build on this output.' },
	]}
/>
...
<ProcessDiagram
	title='Trigger mode comparison'
	steps={[
		{ title: 'Event trigger', description: 'The section is reprocessed when its document set changes.' },
		{ title: 'Scheduled trigger', description: 'The section is processed when the configured cron time arrives.' },
	]}
/>
