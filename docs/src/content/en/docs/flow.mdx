...
<ProcessDiagram
	...
	steps={[
		{
			title: 'Browser opens gateway',
			description: 'Users always enter the product through one public entrypoint.',
		},
		{
			title: 'gateway routes to web or api',
			description: 'Page traffic goes to web, while business traffic is routed to the domestic or overseas API by path.',
		},
		{
